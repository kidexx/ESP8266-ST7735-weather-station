...
void displayData(){
  printGeneral("Your city name", timeS, day, weatherID, description, Fltemperature, umidityPer);
  delay (35000);
  //printWeather("Your city name", timeS, day, weatherID, description);
  //delay (pause);
  printTemperature("Your city name", timeS, day, Fltemperature);
  delay (5000);
  printUmidity("Your city name", timeS, day, umidityPer);
  delay (5000);
  printWind("Your city name", timeS, day, windS);
  delay (5000);
  printVISIBILITY("Your city name", timeS, day,  Visibility);
  delay (5000);
  printairpressure("Your city name", timeS, day,  pressure);
  delay (5000);
  printwindangle("Your city name", timeS, day,  Wind_angle);
  delay (5000);
  printclouds("Your city name", timeS, day,  Clouds);
  delay (5000);
